...
TERMUX_PKG_MAINTAINER="@amuramatsu"
...
lib/libiomp5.a
"
TERMUX_PKG_DEPENDS="libc++, ncurses, libffi, zlib"
# Replace gcc since gcc is deprecated by google on android and is not maintained upstream.
# Conflict with clang versions earlier than 3.9.1-3 since they bundled llvm.
TERMUX_PKG_CONFLICTS="gcc, clang (<< 3.9.1-3)"
TERMUX_PKG_BREAKS="libllvm11-dev"
TERMUX_PKG_REPLACES="gcc, libllvm11-dev"
# See http://llvm.org/docs/CMake.html:
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="
-DCMAKE_INSTALL_PREFIX=$TERMUX_PREFIX/opt/llvm11
...
termux_step_pre_configure() {
	...
	LDFLAGS+=" -L$TERMUX_PREFIX/opt/llvm11/lib -Wl,-rpath=$TERMUX_PREFIX/opt/llvm11/lib"
...
termux_step_post_make_install() {
	...
	mkdir -p $TERMUX_PREFIX/opt/llvm11/share/man/man1
	cp docs/man/* $TERMUX_PREFIX/opt/llvm11/share/man/man1
}
...
termux_step_post_massage() {
	...
	sed $TERMUX_PKG_BUILDER_DIR/llvm-config.in \
		...
		-e "s|@TERMUX_PREFIX@|$TERMUX_PREFIX/opt/llvm11|g" > $TERMUX_PREFIX/opt/llvm11/bin/llvm-config
	chmod 755 $TERMUX_PREFIX/opt/llvm11/bin/llvm-config
}
